...
class PatientRegistrationForm(UserCreationForm):
    class Meta(UserCreationForm.Meta):
        model = Patient
        fields = ("username", 'firstname', 'lastname', 'email', 'phone_number', 'date_of_birth', 'insurance_id', 'address', 'password1', 'password2')

class DoctorRegistrationForm(UserCreationForm):
    class Meta(UserCreationForm.Meta):
        model = Doctor
        fields = ("username", 'firstname', 'lastname', 'email', 'phone_number', 'hospital', 'specialization', 'address', 'password1', 'password2')
