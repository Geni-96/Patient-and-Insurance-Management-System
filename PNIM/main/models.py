...
class Doctor(AbstractUser):
    ...
    user_permissions = models.ManyToManyField(Permission, related_name='doctors')
    class Meta:
...
class InsuranceProvider(AbstractUser):
    ...
    user_permissions = models.ManyToManyField(Permission, related_name='insuranceproviders')
    class Meta:
